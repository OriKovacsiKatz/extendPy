...
.py.reflection.priv.context:{[obj; atr; arg]
  ...
  .test.obj:obj;.test.atr:atr;.test.arg:arg;
  ...
  // windows fix - need to remove first null entiry from 'átr' dictionary;
  dict: `doc _ 1_atr;
  cxt: blk,(,/)value .ut.eachKV[dict;{.py.reflection.priv[y;`cxt][x;z]}[ins]];
